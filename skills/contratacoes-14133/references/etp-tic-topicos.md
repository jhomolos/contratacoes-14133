...
>
> **Se a triagem concluir que é pregão ou concorrência, conduza também o "Bloco 0.5" descrito em `etp-topicos.md`** (Sistema de Registro de Preços vs. contrato único). Ela vale igualmente para TIC — aliás, aquisição de software, licenciamento e hardware por SRP é um dos casos mais frequentes na prática — e a resposta deve ser registrada no **tópico 15** (Descrição da solução de TIC a ser contratada) deste arquivo, do mesmo modo que no tópico 5 do ETP genérico.
